...
def cover():
    print """
     ...
     """
    runntek(WW+" Bienvenido a Upside Down, a partir de ahora tu eres uno de nosotros...")
    time.sleep(1)
    print " "
    print RR+"  +=================================================================+"
    print GL+"  |                           STRANGER                              |"
    print RR+"  +=================================================================+"
    print WW+"  |                       Script BY: Upside Down                    |"
    print GG+"  |              Utilizalo bajo tu propia responsabilidad           |"
    print WW+"  |                     FACEBOOK: Upside Down                       |"
    print Y+ "  |                         Version: 1.0                            |"
    print WW+"  |-----------------------------------------------------------------|"
    print GL+"  |El mundo es un lugar peligroso, no por aquellos que hacen el mal,|"
    print WW+"  |           sino por aquellos que miran y no hacen nada.          |"
    print RR+"  +=================================================================+"
    print GG+"  |         STRANGER : Ataques de fuerza bruta a Facebook           |"
    print RR+"  +=================================================================+"     
...
def welcome():
        wel = GG+"""
En caso de que no logres hackear a tu victima,vuelve a intentarlo,no te rindas,
recuerda que de los errores se aprende
!!!!!!!!! \033[96;4mUpside Down\033[92;1m
       |_|
      """
        print wel
        print " "
        ...
        print RR+" [*] Cantidad de contraseñas :" , len(total),WW+ "passwords"
        print Y+" [*] Iniciando ataque, por favor espere .....\n\n"
